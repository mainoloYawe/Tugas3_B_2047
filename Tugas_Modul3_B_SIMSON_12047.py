...
st.markdown("""
    <div class="center">
        <img src="https://media1.tenor.com/m/uBqT5bkx2KIAAAAC/welcome-cat.gif" alt="Welcome Image">
    </div>
""", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\Informatika\semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam B\Supervised Learning (Praktek)\Model Suprevised Learning (Praktek)\Tugas3_B_2047'
